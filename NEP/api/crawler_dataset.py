...
for article in list_of_articles2:
    print(f"Processing {list_of_articles2.index(article)}")
    article_data = crawl_article_lrb(article)
    number = list_of_articles2.index(article)
    article_data = {f"article{number + 1}": article_data}
    article_list.append(article_data)
